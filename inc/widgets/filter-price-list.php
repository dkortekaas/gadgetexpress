 ...
 * @see   WP_Widget
 */
class Toffe_Dassen_Price_Filter_List_Widget extends WP_Widget {
	...
	public function __construct() {
		$widget_ops  = array(
			'classname'   => 'widget_text gadgetexpress-price-filter-list',
			'description' => esc_html__( 'Shows a price filter list in a widget which lets you narrow down the list of shown products when viewing product categories.', 'gadget' ),
		);
		$control_ops = array( 'width' => 400, 'height' => 350 );
		parent::__construct( 'gadgetexpress-price-filter-list', esc_html__( 'Gadget Express Price Filter List', 'gadget' ), $widget_ops, $control_ops );
	}
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Content:', 'gadget' ); ?></label>
        ...
        <p><?php esc_html_e( 'Enter the price by format: min_price|max_price. Divide price list with linebreaks (Enter). Example:', 'gadget' ); ?></p>
        <p><?php esc_html_e( '100|200', 'gadget' ); ?><br><?php esc_html_e( '200|300', 'gadget' ); ?>
            <br><?php esc_html_e( '300|400', 'gadget' ); ?></p>
		<?php
	}
}
