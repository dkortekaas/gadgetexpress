...
class Toffe_Dassen_Widget_Attributes_Filter extends WC_Widget {
	...
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce gadgetexpress_attributes_filter widget_layered_nav';
		$this->widget_description = esc_html__( 'Shows a custom attribute in a widget which lets you narrow down the list of products when viewing product categories.', 'gadget' );
		$this->widget_id          = 'gadgetexpress_attributes_filter';
		$this->widget_name        = esc_html__( 'Gadget Express Attributes Filter', 'gadget' );
		parent::__construct();
	}
	...
	public function init_settings() {
		...
		$this->settings = array(
			'title'      => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Filter by', 'gadget' ),
				'label' => esc_html__( 'Title', 'gadget' )
			),
			'attribute'  => array(
				'type'    => 'select',
				'std'     => '',
				'label'   => esc_html__( 'Attribute', 'gadget' ),
				'options' => $attribute_array
			),
			'query_type' => array(
				'type'    => 'select',
				'std'     => 'and',
				'label'   => esc_html__( 'Query type', 'gadget' ),
				'options' => array(
					'and' => esc_html__( 'AND', 'gadget' ),
					'or'  => esc_html__( 'OR', 'gadget' )
				)
			),
			'height'     => array(
				'type'  => 'text',
				'std'   => '',
				'label' => esc_html__( 'Height', 'gadget' )
			),
		);
	}
	...
	protected function layered_nav_list( $terms, $taxonomy, $query_type, $height ) {
		...
		foreach ( $terms as $term ) {
			...
			echo apply_filters( 'gadgetexpress_color_filter_nav_count', '<span class="count">' . absint( $count ) . '</span>', $count, $term );
