...
class Toffe_Dassen_PopularPost_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			esc_html__( 'Gadget Express - PopularPost', 'gadget' ),
			array(
				'classname'   => 'popular-posts-widget',
				'description' => esc_html__( 'Display most popular posts', 'gadget' ),
			)
		);
	}
	...
	function form( $instance ) {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'limit' ) ); ?>"><?php esc_html_e( 'Number Of Posts', 'gadget' ); ?></label>
        </p>
