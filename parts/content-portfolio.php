...
$size      = 'gadgetexpress-portfolio-grid';
...
if ( $p_style == 'grid' ) {
	...
	if ( $current % 9 == 2 ) {
		$size = 'gadgetexpress-portfolio-masonry-s';
	} elseif ( $current % 9 == 4 || $current % 9 == 6 || $current % 9 == 7 ) {
		$size = 'gadgetexpress-portfolio-masonry-t';
	} else {
		$size = 'gadgetexpress-portfolio-grid';
	}

} elseif ( $p_style == 'carousel' ) {
	$size = 'gadgetexpress-portfolio-carousel';
	$css .= ' swiper-slide color-' . gadgetexpress_get_option( 'portfolio_text_color' );
}
