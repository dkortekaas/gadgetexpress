...
if ( ! intval( gadgetexpress_get_option( 'related_posts' ) ) ) {
	return;
}
...
$numbers = intval( gadgetexpress_get_option( 'related_posts_numbers' ) );
...
$size = 'gadgetexpress-blog-grid-2';
...
?>
	<div class="gadgetexpress-related-posts blog-grid">
		<div class="related-section-title">
			<?php
			if ( $titles = gadgetexpress_get_option( 'related_posts_title' ) ) {
